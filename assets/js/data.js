/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Здесь живёт весь контент сайта: информация о вас, контакты, навыки,
   опыт и список проектов. Код страниц (HTML/CSS) менять не нужно.

   Три правила:
   1. Текст на двух языках — это всегда пара:  { ru: "...", en: "..." }
      Если английская версия не нужна, напишите в en то же, что и в ru.
   2. Не удаляйте кавычки, запятые и фигурные скобки — по ним сайт понимает,
      где что начинается и заканчивается.
   3. Картинки кладите в папку  assets/img/projects/  и пишите путь
      от корня сайта:  "assets/img/projects/moy-proekt.svg"

   Как добавить новый проект — см. шаблон в самом конце этого файла
   и подробную инструкцию в README.md.
   ========================================================================== */
